...
<section>
    ...
    @section('content')
        ...
        <div class="card">
             <div class="card-header">
                <a class="btn btn-success btn-sm"  href="{{ route('mantenimientos.create') }}"><i class="fas fa-plus-circle mr-2"></i>Programar Nuevo Mantenimiento</a>
             </div>
            <div class="card-body ">
                    ...
                    <tbody>
                        @foreach($mantenimientos as $mantenimiento)
                            <tr>
                                ...
                                <td>{{ $mantenimiento->Fecha_Programacion }}</td>
                                <td>{{ $mantenimiento->Descripcion }}</td>
                                <td>{{ $mantenimiento->UsuarioID }}</td>
                                <td width="1px"><a class="btn btn-primary btn-sm"  href="{{ route('mantenimientos.show', $mantenimiento) }}"><i class="fas fa-eye"></i></a></td>
                                <td width="10px"><a class="btn btn-warning btn-sm"  href="{{ route('mantenimientos.edit', $mantenimiento) }}"><i class="fas fa-pencil-alt"></i></a></td>
                                <td width="10px">
